...
func compare<T>(_ lhs: TJBoundType<T>, _ rhs: TJBoundType<T>) -> Int {
    switch (lhs, rhs) {
...
func compare<T>(_ lhs: T, _ rhs: TJBoundType<T>) -> Int {
    return compare(.Closed(lhs), rhs)
}

func compare<T>(_ lhs: TJBoundType<T>, _ rhs: T) -> Int {
